...
* rest[=].resource[=].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].extension.valueCode = #SHALL
* rest[=].resource[=].supportedProfile[+] = "http://moh.bw.org/StructureDefinition/bw-patient"
* rest[=].resource[=].supportedProfile[+] = "http://moh.bw.org/StructureDefinition/patient-identity-cross-reference"
* rest[=].resource[=].interaction[+].code = #create
* rest[=].resource[=].interaction[+].code = #read
...
* rest[=].resource[+].type = #ExampleScenario
* rest[=].resource[=].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].extension.valueCode = #MAY
* rest[=].resource[=].profile = "http://moh.bw.org/StructureDefinition/bw-scenarios"
* rest[=].resource[=].interaction[+].code = #create
* rest[=].resource[=].interaction[+].code = #read
* rest[=].resource[=].interaction[+].code = #update